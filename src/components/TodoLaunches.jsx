...
//             value={launchInput.name}
//             onChange={(e) => setLaunchInput({ ...launchInput, name: e.target.value })}
//           />
//           <input
//             type="date"
//             value={launchInput.date}
//             onChange={(e) => setLaunchInput({ ...launchInput, date: e.target.value })}
//           />
//           <input
//             type="text"
//             placeholder="Launch Location"
//             value={launchInput.location}
//             onChange={(e) => setLaunchInput({ ...launchInput, location: e.target.value })}
//           />
//           <input
//             type="text"
//             placeholder="T-0 Time (UTC)"
...
//                   <input
//                     type="text"
//                     value={editedLaunch.name}
//                     onChange={(e) => setEditedLaunch({ ...editedLaunch, name: e.target.value })}
//                   />
//                   <input
//                     type="date"
//                     value={editedLaunch.date}
//                     onChange={(e) => setEditedLaunch({ ...editedLaunch, date: e.target.value })}
//                   />
//                   <input
//                     type="text"
//                     value={editedLaunch.location}
//                     onChange={(e) => setEditedLaunch({ ...editedLaunch, location: e.target.value })}
//                   />
//                   <input
//                     type="text"
//                     value={editedLaunch.t0Time}
//                     onChange={(e) => setEditedLaunch({ ...editedLaunch, t0Time: e.target.value })}
//                   />
...
const TodoLaunches = () => {
  ...
  // Save to localStorage whenever launches change
  useEffect(() => {
    localStorage.setItem("launches", JSON.stringify(launches));
  }, [launches]);
